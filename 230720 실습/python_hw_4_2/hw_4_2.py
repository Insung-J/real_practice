...
missing_book = [f'{book}을 보충하여야 합니다.' for book in rental_book if book not in list_of_book]

# missing_book = ['모든 도서가 대여 가능한 상태입니다' for book in rental_book if rental_book == list_of_book]
